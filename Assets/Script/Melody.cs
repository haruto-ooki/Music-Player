...
public class Melody : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        PlaySineTone("F", 5, "16", BPM);
        yield return new WaitForSeconds(GetDuration("16", BPM));

        PlaySineTone("B-", 4, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));
        ...
        PlaySineTone("C", 5, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));

        PlaySineTone("E-", 5, "16", BPM);
        yield return new WaitForSeconds(GetDuration("16", BPM));

        PlaySineTone("F", 5, "16", BPM);
        yield return new WaitForSeconds(GetDuration("16", BPM));

        PlaySineTone("G", 5, "16", BPM);
        yield return new WaitForSeconds(GetDuration("16", BPM));
        ...
        PlayTiedSineSequence(new string[][] {
            new string[] { "8~", "F", "5" },
            new string[] { "8",  "F", "5" },
        }, BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM) * 2);

        PlaySineTone("E-", 5, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));

        PlaySineTone("D", 5, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));
        ...
        yield return new WaitForSeconds(GetDuration("2", BPM));
        ...
        PlaySineTone("F", 5, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));

        PlaySineTone("F", 4, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));

        PlaySineTone("G", 4, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));

        PlaySineTone("B-", 3, "8", BPM);
        yield return new WaitForSeconds(GetDuration("8", BPM));
